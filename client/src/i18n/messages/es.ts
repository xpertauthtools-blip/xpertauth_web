const es = {
  ...
  quota: [
    ...
    bannerTitle: "XpertAuth está en proceso de constitución",
    bannerDesc: "Todavía no podemos admitir socios formalmente, pero puedes registrar tu interés ahora. Cuando la asociación esté constituida, serás el primero en saberlo — y el primero en poder hacerte socio. Además, al registrarte hoy accedes a más consultas gratuitas con nuestros agentes.",
