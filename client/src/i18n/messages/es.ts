const es = {
  ...
  socialProof: {
    ...
    stats: [
      ...
      { value: "1000+", label: "Consultas resueltas" },
  ...
  waitlist: {
    ...
    subtitle: "Sé de los primeros en acceder cuando lancemos. Sin compromiso.",
    nameLabel: "Nombre",
    ...
    successMessage: "Te avisaremos cuando todo esté listo. Gracias por confiar en XpertAuth.",
