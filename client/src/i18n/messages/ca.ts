const ca = {
  ...
  pricingNote: "Preus orientatius: Explorador (gratis), Professional & PIMEs (~8€/mes), Gran Empresa (~150€/mes). Es confirmaran quan l'associació estigui constituïda.",
  quota: [
    ...
    bannerTitle: "XpertAuth està en procés de constitució",
    bannerDesc: "Encara no podem admetre socis formalment, però pots registrar el teu interès ara. Quan l'associació estigui constituïda, seràs el primer a saber-ho — i el primer a poder fer-te soci. A més, en registrar-te avui accedeixis a més consultes gratuïtes amb els nostres agents.",
