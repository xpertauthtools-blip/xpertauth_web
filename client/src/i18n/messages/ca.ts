const ca = {
  ...
  waitlist: {
    title: "Uneix-te a la llista d'espera",
    subtitle: "Sigues dels primers en accedir quan llancem. Sense compromís.",
    nameLabel: "Nom",
    namePlaceholder: "El teu nom",
    emailLabel: "Email",
    emailPlaceholder: "tu@email.com",
    submit: "Unir-me a la llista d'espera",
    sending: "Enviant...",
    successTitle: "Ets a la llista!",
    successMessage: "T'avisarem quan tot estigui llest. Gràcies per confiar en XpertAuth.",
