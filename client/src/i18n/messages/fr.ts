const fr = {
  ...
  waitlist: {
    ...
    subtitle: "Soyez parmi les premiers à accéder lors du lancement. Sans engagement.",
    nameLabel: "Nom",
    ...
    successMessage: "Nous vous informerons quand tout sera prêt. Merci de faire confiance à XpertAuth.",
