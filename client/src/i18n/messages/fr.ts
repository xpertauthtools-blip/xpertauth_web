const fr = {
  ...
  pricingNote: "Prix indicatifs : Explorateur (gratuit), Professionnel & PME (~8€/mois), Grande Entreprise (~150€/mois). Ils seront confirmés définitivement une fois l'association constituée.",
  quota: [
    ...
    bannerTitle: "XpertAuth est en cours de constitution",
    bannerDesc: "Nous ne pouvons pas encore admettre formellement de membres, mais vous pouvez enregistrer votre intérêt dès maintenant. Lorsque l'association sera constituée, vous serez le premier à le savoir — et le premier à pouvoir devenir membre. De plus, en vous inscrivant aujourd'hui, vous accédez à plus de consultations gratuites avec nos agents.",
