              ...
              <div className="absolute inset-4 rounded-xl border-2 border-dashed border-ember/20 flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <div className="mt-6 flex items-center justify-center gap-2">
                    {[1, 2, 3, 4, 5, 6].map((n) => (
                      <div key={n} className="w-8 h-8 rounded-full bg-ember/10 border-2 border-white flex items-center justify-center -ml-1 first:ml-0">
                        <span className="text-ember text-[10px] font-bold">{n}</span>
                      </div>
                    ))}
                  </div>
                  <p className="mt-2 text-obsidian/30 text-xs">{m.illustrationCaption}</p>
                </div>
              </div>
            </div>
          </motion.div>
