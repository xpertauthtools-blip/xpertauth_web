      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 pb-12 border-b border-white/[0.06]">
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-6">
              Asociación sin ánimo de lucro que combina experiencia humana con
              inteligencia artificial para crear un futuro más accesible.
            </p>
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-9 h-9 rounded-md bg-white/[0.05] flex items-center justify-center text-white/40 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: "Formación Senior", href: "#formacion-senior" },
          ...
          <div>
            ...
            <p className="text-white/40 text-sm mb-4">
              Recibe novedades sobre transporte, IA y formación digital.
            </p>
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-xpertblue text-pure text-sm font-semibold rounded-md transition-all duration-200 disabled:opacity-60 flex items-center justify-center gap-2"
                  data-testid="button-footer-newsletter"
                >
                  {mutation.isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : "Suscribirse"}
                </button>
                {mutation.isError && (
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-wrap items-center justify-center gap-4 text-white/25 text-xs">
            <a href="#" data-testid="link-privacy">Política de Privacidad</a>
            <span>|</span>
            <a href="#" data-testid="link-legal">Aviso Legal</a>
            <span>|</span>
            <a href="#" data-testid="link-cookies">Cookies</a>
          </div>

          <p className="text-white/20 text-xs text-center md:text-right">
            Contenido creado y desarrollado con ayuda de Inteligencia Artificial.
          </p>
        </div>

        <div className="mt-4 text-center">
          <p className="text-white/15 text-xs">
            &copy; {new Date().getFullYear()} XpertAuth. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
